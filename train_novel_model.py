# -*- coding: utf-8 -*-
"""train_novel_model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PndTbMDtnMEAPFn2yqKgY3CRIGfBlYTe
"""
...
class TransformerBlock(tf.keras.layers.Layer):
    ...
    def call(self, inputs, training=False): # Add training argument here
...
def build_hybrid_model(seq_input_shape, cnn_input_shape):
    ...
    x1 = transformer_block(seq_input) # training argument will be passed by the Model
